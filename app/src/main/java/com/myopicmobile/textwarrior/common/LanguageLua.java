...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="and|break|case|catch|continue|default|defer|do|else|elseif|end|false|finally|for|function|goto|if|in|lambda|local|nil|not|or|repeat|return|switch|then|true|try|until|when|while";
	private final static String globalTarget="self|__add|__band|__bnot|__bor|__bxor|__call|__close|__concat|__div|__eq|__gc|__idiv|__index|__le|__len|__lt|__mod|__mul|__newindex|__pow|__shl|__shr|__sub|__tostring|__unm|_ENV|_G|assert|collectgarbage|dofile|error|getfenv|getmetatable|ipairs|load|loadfile|loadstring|module|next|pairs|pcall|print|warn|rawequal|rawget|rawlen|rawset|require|select|self|setfenv|setmetatable|tointeger|tonumber|tostring|type|unpack|xpcall";
	
	private final static String packageName="coroutine|debug|io|luajava|math|os|package|string|table|utf8|bit";
	...
	private final static String package_bit = "arshift|band|bnot|bor|bxor|btest|extract|lrotate|lshift|replace|rrotate|rshift";
	...
	private LanguageLua(){
		...
		super.addBasePackage("bit",package_bit.split("\\|"));
	}
